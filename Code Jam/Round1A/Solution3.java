...
public class Solution {
    ...
    static class Point {
        ...
        public String toString(){
            ...
            sb.append(" r="+r);
            sb.append(" c="+c);
            //sb.append(" neighbors="+neighbors.toString());
            return sb.toString();
        }
    }
        ...
        while (!delete.isEmpty()) {
            ...
            for (int i = 0; i < deleteSize; i++) {
                ...
                for (Point neighbor : pointDelete.neighbors) {
                    if(has[neighbor.r][neighbor.c]){
                        System.out.println("this is point: "+neighbor);
                        System.out.println("before: "+neighbor.neighbors);
                        ...
                        System.out.println("after: "+neighbor.neighbors);
                    }
